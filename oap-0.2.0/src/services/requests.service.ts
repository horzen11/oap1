...
export const requestsService = {
  ...
  update(id: string, dto: CreateRequestRequestDto): EquipmentRequest {
  ...
  patch(id: string, dto: PatchRequestRequestDto): EquipmentRequest {
    const existing = this.getById(id);
